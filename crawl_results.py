...
# All URLs collected from first pass (services.html)
page1_services = [
...
# From promotions.html (additional links not in services)
page2_promotions_extra = [
...
# From supply-center.html (redirected to pcr.html - additional links)
page3_supply_extra = [
...
# From aspire-member-program.html (redirected to cell-culture.html - additional links)
page4_aspire_extra = [
...
global_trademark_extra = [
  # No additional unique links found beyond common nav
]
...
# Combine all
all_urls = set()
for lst in [page1_services, page2_promotions_extra, page3_supply_extra, page4_aspire_extra, 
            global_terms_extra, global_privacy_extra, global_policies_extra, global_trademark_extra,
            aboutus_oem_extra]:
    all_urls.update(lst)

# Also add the starting URLs themselves
starting_urls = [
  "https://www.thermofisher.com/us/en/home/products-and-services/services.html",
  "https://www.thermofisher.com/us/en/home/products-and-services/promotions.html",
  "https://www.thermofisher.com/us/en/home/products-and-services/supply-center.html",
...
# Add the eprocurement URL found on lab-equipment page
all_urls.add("https://www.thermofisher.com/us/en/home/products-and-services/eprocurement/eprocurement-solutions-contact-form.html")

print(f"Total unique URLs so far: {len(all_urls)}")

# Save to JSON for later processing
with open('/workspace/all_urls_pass1.json', 'w') as f:
    json.dump(sorted(all_urls), f, indent=2)

print("Saved to /workspace/all_urls_pass1.json")
